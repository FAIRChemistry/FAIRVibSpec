...
- __experiment_type__
  - Type: MeasurementSeries, QualitativeMeasurement
  - Description: Nature of the experiment(s) performed.
- purpose
  - Type: string
...
- parameter_unit
  - Type: UnitDefinition
  - Description: Unit of the varied parameter. Was UnitDefinition.
- parameter_series
  - Type: float[]
  - Description: Values of the varied parameter. Must be of length measurement_ids.
- measurement_ids
  - Type: string[]
  - Description: IDs of the measurements that are part of the series. Must be of length parameter_series.
